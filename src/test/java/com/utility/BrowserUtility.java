...
public abstract class BrowserUtility {
	...
	public void clickOn(WebElement element) {
		...
		logger.info("performing click on " + element);
		element.click();
	}
	...
	public void clearText(By textBoxLocator) {
		...
		WebElement webElement = wait.until(ExpectedConditions.elementToBeClickable(textBoxLocator));
	...
	public List<WebElement> getAllElements(By locator) {
		logger.info("Finding all elements  with the locator " + locator);
		List<WebElement> elementList = driver.get().findElements(locator);
		logger.info("Elements found and now returning the list");
		return elementList;
	}
	...
	public String takeScreenshot(String testName) {
		...
		try {
			...
			// path = System.getProperty("user.dir")+"//screeshots//"+testName+" -
			// "+timeStamp+"png";
